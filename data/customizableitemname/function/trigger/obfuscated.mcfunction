...
execute if data entity @s SelectedItem.components."minecraft:custom_name"{obfuscated:true} run data modify storage customizableitemname:data new_item_name.obfuscated set value false
execute if data entity @s SelectedItem.components."minecraft:custom_name"{obfuscated:false} run data modify storage customizableitemname:data new_item_name.obfuscated set value true
